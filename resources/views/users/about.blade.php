...
<body>
    ...
    {{-- about us --}}
    <div class="about" style="width:60%;height:auto; margin:0 auto; font-family:sans-serif">
        <h1 style="text-align:center;padding:20px; font-size:40px;"><b>Why us ???</b></h1>
        <h3>Mediqueing system is the way of providing  facility to the patient online.Either it is appointment 
    ...
    <div class="gallery" style="width:50%;height:auto; display:flex;justify-content:space-around;padding:30px;margin:0 auto;flex-wrap:wrap; gap:10px;">
    <img src="images/covid.jpg" style="width:200px;height:150px;">
    <img src="images/medicare.jpg" style="width:200px;height:150px;">
    <img src="images/covid.jpg" style="width:200px;height:150px; ">
    <img src="images/mediimg.jpg" style="width:200px;height:150px;">
    <img src="images/mediimg.jpg" style="width:200px;height:150px;">
    <img src="images/medicare.jpg" style="width:200px;height:150px;">
    ...
    <footer class="text-center text-white " style="background-color: #f1f1f1;">
        <div class="container pt-9  mx-12 px-5">
